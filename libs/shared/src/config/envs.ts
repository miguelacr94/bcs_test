...
export const envs = {
  mongo: {
    ...
    apiGatewayUri: process.env.MONGO_URI_API_GATEWAY || 'mongodb://127.0.0.1:27017/bcs_api_gateway_db',
    tracingUri: process.env.MONGO_URI_TRACING || 'mongodb://127.0.0.1:27017/bcs_tracing_db',
  },
